const QUESTION_BANK = {
  easy: [
    ...
    {
      id: 6,
      title: 'SMS עם חוב וקישור מקוצר',
      prompt: 'קיבלת SMS שטוען שקיים חוב פתוח, כולל מספר בירור ותעודת זהות חלקית, ומפנה ל-TinyURL לתשלום.',
      choices: [
        { label: 'לא לוחצים; נכנסים עצמאית לאתר או לאפליקציה הרשמית ובודקים שם', correct: true },
        { label: 'אפשר ללחוץ כי ההודעה מכירה את תעודת הזהות', correct: false },
        { label: 'אפשר ללחוץ כי המספר השולח ישראלי', correct: false }
      ],
      explanation: 'מידע אישי ומספר ישראלי אינם הוכחת אמינות. קישור מקוצר מסתיר את היעד ולכן מאמתים דרך ערוץ רשמי ונפרד.'
    }
  ],
  medium: [
    {
    ...
    {
      id: 7,
      title: 'ההודעה יודעת עליך פרטים',
      prompt: 'SMS חשוד כולל את שמך, מספר הטלפון שלך וחלק ממספר תעודת הזהות. מה זה מוכיח?',
      choices: [
        { label: 'זה לא מוכיח שהשולח אמיתי; המידע יכול להגיע ממאגר שדלף', correct: true },
        { label: 'רק גוף רשמי יכול לדעת את הפרטים האלה', correct: false },
        { label: 'אם לפחות שני פרטים נכונים, הקישור בטוח', correct: false }
      ],
      explanation: 'תוקפים משתמשים במידע אמיתי שנאסף או דלף כדי להפוך Smishing למותאם אישית ומשכנע יותר.'
    }
  ],
  hard: [
    {
    ...
    {
      id: 8,
      title: 'אימות הודעה ממשלתית',
      prompt: 'הודעת SMS מציגה שם של רשות ממשלתית, מספר תיק וקישור מקוצר. מהי דרך האימות הטובה ביותר?',
      choices: [
        { label: 'לפתוח באופן עצמאי את gov.il או את האפליקציה הרשמית ולבדוק אם הדרישה קיימת', correct: true },
        { label: 'ללחוץ על הקישור ולבדוק אם האתר נראה מקצועי', correct: false },
        { label: 'להשיב ל-SMS ולבקש מהשולח לאשר שהוא אמיתי', correct: false }
      ],
      explanation: 'אימות אמיתי מתבצע בערוץ נפרד מההודעה החשודה. עיצוב מקצועי, מספר תיק או שם שולח אינם מספיקים.'
    }
  ]
};
